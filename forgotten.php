	...
	<div class="container">
		<div class="row">
			<div class="col-xs-10 col-xs-offset-1 col-md-4 col-md-offset-4 formContainer">
				...
				<div class="formBody">
					<form role="form" action="php/submit/passwordRequest.php" class="containedForm">
						<div class="formInstructions">
							<label for="instructions">Set up a new password</label>
							<p id="instructions">Submit your email or username and we will send you instruction on how to set up a new password.</p>
						</div>
						...
						<!--<div class="formQuote">
							<p class="text-center quote">"Write what should not be forgotten"</p>
							<p class="text-right author">Isabel Allende</p>
						</div>-->
					</form>
				</div>
			</div>
